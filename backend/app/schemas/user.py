...
class UserResponse(UserBase):
    ...
    last_login: datetime | None = Field(default=None, description="The last login time of the user")
    created_at: datetime = Field(..., description="The creation time of the user")
    updated_at: datetime = Field(..., description="The last update time of the user")
